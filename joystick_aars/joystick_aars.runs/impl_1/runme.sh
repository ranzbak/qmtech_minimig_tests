...
HD_PWD='/home/paul/work/fpga/Xilinx/artix7/projects/joystick_aars/joystick_aars.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log joystick_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source joystick_top.tcl -notrace
