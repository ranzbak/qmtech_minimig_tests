...
HD_PWD='/home/paul/work/fpga/Xilinx/artix7/projects/joystick_aars/joystick_aars.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log joystick_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source joystick_top.tcl
