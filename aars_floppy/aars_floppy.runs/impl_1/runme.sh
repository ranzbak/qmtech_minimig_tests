...
HD_PWD='/home/paul/work/fpga/Xilinx/artix7/projects/aars_floppy/aars_floppy.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log floppy_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source floppy_top.tcl -notrace
