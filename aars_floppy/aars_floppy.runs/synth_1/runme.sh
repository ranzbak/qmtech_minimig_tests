...
HD_PWD='/home/paul/work/fpga/Xilinx/artix7/projects/aars_floppy/aars_floppy.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log floppy_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source floppy_top.tcl
