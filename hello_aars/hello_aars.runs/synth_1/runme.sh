...
HD_PWD='/home/paul/work/fpga/Xilinx/artix7/qmtech_minimig_tests/hello_aars/hello_aars.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log hello_aars_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source hello_aars_top.tcl
