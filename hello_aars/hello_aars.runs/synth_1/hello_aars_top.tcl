...
write_checkpoint -force -noxdef -incremental_synth hello_aars_top.dcp
create_report "synth_1_synth_report_utilization_0" "report_utilization -file hello_aars_top_utilization_synth.rpt -pb hello_aars_top_utilization_synth.pb"
